...
export default function ServicePage({ params }: { params: { id: string } }) {
  ...
  const service = getServiceById(params.id) || services[0]
        ...
        <main className="flex-1 container py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/70">({service.totalReviews} reviews)</span>
                  </div>
              ...
              <Tabs defaultValue="description">
                ...
                <TabsContent value="reviews" className="mt-6 space-y-6">
                  {reviews.length > 0 ? (
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex">
                                {Array.from({ length: 5 }).map((_, j) => (
                                  <StarIcon
                                    key={j}
                                    className={`h-4 w-4 ${j < review.rating ? "text-yellow-500 fill-yellow-500" : "text-white/40"}`}
                                  />
                                ))}
                              </div>
                            </div>
                            <p className="text-sm text-white/70">{formatDate(review.createdAt)}</p>
                            ...
                            {review.freelancerResponse && (
                              <div className="mt-3 pl-4 border-l-2 border-white/20">
                                ...
                                <p className="text-sm text-white/70">{review.freelancerResponse}</p>
                              </div>
                            )}
                          </div>
                        </div>
                    ...
                    <p className="text-white/70">No reviews yet. Be the first to review this service!</p>
                  )}
                </TabsContent>
            ...
            <div className="space-y-6">
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <TabsTrigger value="basic" className="relative">
                            Basic
                            <HelpCircle className="h-3 w-3 ml-1 inline-block text-white/50" />
                          </TabsTrigger>
                        </TooltipTrigger>
              ...
              {freelancer && (
                <Card className="bg-card text-white sticky top-24">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-white/70">{freelancer.email.split("@")[0]}.eth</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4">
                      <div className="flex flex-col items-center p-3 bg-muted rounded-lg">
                        <Calendar className="h-5 w-5 mb-1 text-white/70" />
                        <span className="text-sm font-medium">Member since</span>
                        <span className="text-xs text-white/70">Jan 2023</span>
                      </div>
                      <div className="flex flex-col items-center p-3 bg-muted rounded-lg">
                        <Award className="h-5 w-5 mb-1 text-white/70" />
                        <span className="text-sm font-medium">Completed</span>
                        <span className="text-xs text-white/70">{freelancer.completedProjects} orders</span>
                      </div>
                    </div>
                ...
                <tbody>
                  ...
                  <tr className="border-b border-white/10">
                    ...
                    <td className="py-4 px-6 text-center">
                      <X className="h-5 w-5 mx-auto text-white/50" />
                    </td>
